...
- Name: shows report data after scan
- Location: C:\Users\OrEo2\Desktop\DevOps\1. Projects\docker-buster\frontend\tests\example.spec.ts:17:5
...
Call log:
  ...
  - waiting for getByRole('tab', { name: /Executive Summary/i })
    ...
    at C:\Users\OrEo2\Desktop\DevOps\1. Projects\docker-buster\frontend\tests\example.spec.ts:22:71
```
