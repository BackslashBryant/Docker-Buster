...
- Name: downloads PDF and JSON reports
- Location: C:\Users\OrEo2\Desktop\DevOps\1. Projects\docker-buster\frontend\tests\example.spec.ts:26:5
...
Locator: getByRole('tab', { name: /Executive Summary/i })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 20000ms
  - waiting for getByRole('tab', { name: /Executive Summary/i })

    at C:\Users\OrEo2\Desktop\DevOps\1. Projects\docker-buster\frontend\tests\example.spec.ts:31:71
```
...
```yaml
- main:
  - img "Docker Buster Logo"
  - heading "DOCKER BUSTER" [level=1]
  - paragraph: Container security at lightning speed
  - tablist:
    - tab "Image Name" [selected]
    - tab "Registry Link"
    - tab "Upload .tar"
  - tabpanel "Image Name":
    - text: Docker Image Name
    - textbox "Docker Image Name": alpine:latest
  - button "Bust Container":
    - img
    - text: Bust Container
  - paragraph: "Error: Failed to fetch"
  - button "Show advanced options"
  - heading "Scan Failed" [level=2]
